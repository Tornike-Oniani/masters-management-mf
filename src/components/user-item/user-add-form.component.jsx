...
const UserAddForm = ({ createAction, setVisibility }) => {
  ...
  return (
    <tr className="flex flex-col text-base text-gray-700 border border-green-700 rounded p-2 mb-3 md:p0 md:m-0 md:border-b md:table-row">
      <td className="hidden md:table-cell md:table-row-item md:border-l-8 md:border-green-700">
        &nbsp;
      </td>
